...
class CreateApplePayPaymentTest {
    ...
    fun initialize() {
        client = SpreedlyClient.newInstance(
            envKey = "A54wvT9knP8Sc6ati68epUcq72l",
            envSecret = "0f0Cpq17bb5mAAUxtx0QmY2mXyHnEk26uYTrPttn4PIMKZC4zdTJVJSk4YHbe1Ij",
            test = true,
        )
...
""",
        ...
        val trans = client.createApplePaymentMethod(applePayInfo)
